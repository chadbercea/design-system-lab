        ...
        <div className="bg-black/60 border-b border-black px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <img src="/design-system-lab/docker-image-runner/docker-logo.svg" alt="Docker" className="w-12 h-12" />
              <div>
          ...
          {step === 'consent' && (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="bg-black/40 border border-black rounded-lg p-6 space-y-4">
                <div className="flex items-center gap-4">
                  <img src="/design-system-lab/docker-image-runner/docker-logo.svg" alt="Docker" className="w-14 h-14" />
                  <div>
